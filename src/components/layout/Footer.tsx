    ...
    <footer className="bg-gray-900 text-white w-full ">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-semibold mb-4">About StyleShop</h3>
            <p className="text-gray-400">
              Your one-stop destination for trendy men&apos;s and women&apos;s fashion. We offer high-quality clothing at affordable prices.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/men" className="text-gray-400 hover:text-white">
                  Men&apos;s Collection
                </a>
              </li>
              <li>
                <a href="/women" className="text-gray-400 hover:text-white">
                  Women&apos;s Collection
                </a>
              </li>
              <li>
          ...
          <div className="w-full">
            ...
            <form className="flex flex-col  w-full">
              <input
                ...
                className=" placeholder-white w-full sm:w-auto flex-1 px-4 py-2 rounded-t-md sm:rounded-l-md sm:rounded-r-none text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              .
              <button
                type="submit"
                className="w-full sm:w-auto bg-indigo-600 text-white px-4 py-2 rounded-b-md sm:rounded-r-md sm:rounded-l-none hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              >
                Subscribe
              </button>
            </form>
